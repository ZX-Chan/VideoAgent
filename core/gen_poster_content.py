...
def gen_bullet_point_content(args, actor_config, critic_config, agent_modify=False, tmp_dir='tmp'):
    ...
    save_json_file(bullet_point_content, 'contents', paper_name, f'{args.poster_name}_bullet_point_content_{args.index}.json', args.model_name_t, args.model_name_v)
...
def gen_poster_content(args, actor_config):
    ...
    save_json_file(poster_content, 'contents', paper_name, f'{args.poster_name}_poster_content_{args.index}.json', args.model_name_t, args.model_name_v)
