...
# 路径管理工具
from utils.path_utils import get_paper_name_from_path, load_json_file, save_json_file
...
def filter_image_table(args, filter_config):
    ...
    doc_json = load_json_file('contents', paper_name, f'{args.poster_name}_raw_content.json', args.model_name_t, args.model_name_v)
    ...
    save_json_file(images, 'images_and_tables', paper_name, f'{args.poster_name}_images_filtered.json', args.model_name_t, args.model_name_v)
    save_json_file(tables, 'images_and_tables', paper_name, f'{args.poster_name}_tables_filtered.json', args.model_name_t, args.model_name_v)
...
def gen_outline_layout_v2(args, actor_config):
    ...
    paper_name = get_paper_name_from_path(args.poster_path)
    doc_json = load_json_file('contents', paper_name, f'{args.poster_name}_raw_content.json', args.model_name_t, args.model_name_v)
    filtered_table_information = load_json_file('images_and_tables', paper_name, f'{args.poster_name}_tables_filtered.json', args.model_name_t, args.model_name_v)
    filtered_image_information = load_json_file('images_and_tables', paper_name, f'{args.poster_name}_images_filtered.json', args.model_name_t, args.model_name_v)
...
def gen_outline_layout_v3(args, actor_config):
    total_input_token, total_output_token = 0, 0
    agent_name = 'poster_planner_new_v3'
    # 获取论文名称并使用新的路径结构
    paper_name = get_paper_name_from_path(args.poster_path)
    doc_json = load_json_file('contents', paper_name, f'{args.poster_name}_raw_content.json', args.model_name_t,
                              args.model_name_v)
    filtered_table_information = load_json_file('images_and_tables', paper_name,
                                                f'{args.poster_name}_tables_filtered.json', args.model_name_t,
                                                args.model_name_v)
    filtered_image_information = load_json_file('images_and_tables', paper_name,
                                                f'{args.poster_name}_images_filtered.json', args.model_name_t,
                                                args.model_name_v)
